...
from files_api.aws.utils import get_ecs_client, get_sqs_client
...
def create_ecs_task_manager(cluster_name: str = None, service_name: str = None) -> ECSTaskManager:
    ...
    return ECSTaskManager(cluster_name, service_name)


# Global task manager instance for easy access
_task_manager_instance: Optional[ECSTaskManager] = None


def get_task_manager() -> ECSTaskManager:
